...
$stmt = $pdo->prepare("
    SELECT t.*, s.name AS section_name, c.name AS created_name
    FROM tasks t
   ...
   class="btn btn-sm btn-outline-primary">
    <i class="bi bi-download"></i> Download
                ...
                <form method="POST" action="../actions/update-task-status.php">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="bi bi-play-fill"></i> Start Task (Mark as In Progress)</button>
                </form>
