...
$stmt = $pdo->prepare("
    SELECT t.*, s.name AS section_name, c.name AS created_name, c.role AS created_role
    FROM tasks t
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="my-tasks.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Back</a>
</div>
            ...
            <div class="card-body">
                ...
                <div class="row g-3 small">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php if (($task['created_role'] ?? '') === 'admin'): ?>
                            <span class="badge bg-danger"><?php echo e($task['created_name']); ?></span>
                ...
                <hr>
                <form method="POST" action="../actions/update-task-status.php">
...
<div class="modal fade" id="completeModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="../actions/update-task-status.php" enctype="multipart/form-data">
                <input type="hidden" name="csrf_token" value="<?php echo generateCSRFToken(); ?>">
                <input type="hidden" name="task_id" value="<?php echo $task['id']; ?>">
