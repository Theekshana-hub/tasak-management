...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="task-details.php?id=<?php echo $task['id']; ?>" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Back</a>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="POST" action="../actions/update-task-full.php" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="section_id" class="form-select" required>
                        ...
                        <option value="<?php echo $s['id']; ?>" <?php echo $task['section_id']==$s['id']?'selected':''; ?>><?php echo e($s['name']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-6">
                    ...
                    <select name="assigned_to" class="form-select" required>
                        ...
                        <option value="<?php echo $u['id']; ?>" <?php echo $task['assigned_to']==$u['id']?'selected':''; ?>><?php echo e($u['name']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-4">
                    ...
                    <select name="priority" class="form-select">
                        ...
                        <option value="<?php echo $p; ?>" <?php echo $task['priority']===$p?'selected':''; ?>><?php echo $p; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-4">
                    ...
                    <select name="status" class="form-select">
                        ...
                        <option value="<?php echo $st; ?>" <?php echo $task['status']===$st?'selected':''; ?>><?php echo $st; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-4">
            ...
            <div class="mt-4">
                <button type="submit" class="btn btn-coral"><i class="bi bi-check-lg"></i> Update Task</button>
            </div>
        </form>
    </div>
</div>
